...
create table sneakers_society.producto (
  ...
  foreign key fk_producto_caregoria (id_marca) references marcas(id_marca)  
)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
INSERT INTO sneakers_society.usuario (id_usuario, username,password,nombre, apellidos, correo, telefono,ruta_imagen,activo) VALUES 
...
(2,'oscar','$2a$10$GkEj.ZzmQa/aEfDmtLIh3udIH5fMphx/35d0EYeqZL5uzgCJ0lQRi','Oscar',  'Contreras Mora', 'ocontreras@gmail.com', '5456-8789','https://upload.wikimedia.org/wikipedia/commons/0/06/Photo_of_Oscar_Arthur.jpg',true),
...
/*Se insertan 3 marcass de productos como ejemplo */
INSERT INTO sneakers_society.marcas (id_marcas,descripcion,ruta_imagen,activo) VALUES 
...
/*Se insertan 4 productos por marcas */
INSERT INTO sneakers_society.producto (id_producto,id_marca,descripcion,detalle,precio,existencias,ruta_imagen,activo) VALUES
