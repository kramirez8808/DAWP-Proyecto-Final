...
ALTER TABLE sneakers_society.rol ADD FOREIGN KEY (id_usuario) REFERENCES usuario(id_usuario);

ALTER TABLE sneakers_society.rol DROP FOREIGN KEY rol_ibfk_1;

ALTER TABLE sneakers_society.usuario DROP FOREIGN KEY usuario_ibfk_1;

ALTER TABLE sneakers_society.usuario DROP id_rol;
...
(1,'admin','admin123','Admin', 'Default',    'admin@default.com',    '4556-8978', 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Justin_Diego_Madrigal.jpg/250px-Justin_Diego_Madrigal.jpg',true),
(2,'user1','user123','User1',  'Default', 'user1@default.com', '5456-8789','https://upload.wikimedia.org/wikipedia/commons/0/06/Photo_of_Oscar_Arthur.jpg',true),
(3,'user2','user123','User2', 'Default',     'user2@default.com',      '7898-8936','https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/Eduardo_de_Isaac_2019.jpg/480px-Eduardo_de_Isaac_2019.jpg?20200109230854',true);
